    ...
    <>
      <div>
        ...
        <Details>
          ...
          >
            <CardTitle>Bank App</CardTitle>
          </a>
          <Desc>
          A banking management system that helps track transaction, management account and transfer funds with credit cards
          </Desc>
          <ProjectLinks>
            <a
              href="https://github.com/vickybanti/BankApp.git
"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://bankmoore.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
            >
